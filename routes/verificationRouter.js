...
verificationRouter.get('/documentScan/me/:kindOfDocument',auth, (req,res) => verificationController.getMyScanStatus (req, res))
...
verificationRouter.get('/documentScan/admin/',auth, (req,res) => verificationController.getScanForAdmin (req, res))
